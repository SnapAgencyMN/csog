<div id="login_wrapper">
  <form action="<?php echo WS_URL;?>projects/" method="post">
    <div><label>Username:</label><br /><input name="user" id="user" type="text" maxlength="16" /></div>
    <div><label>Password:</label><br /><input name="pass" id="pass" type="password" maxlength="16" /></div>
