...
?>
  <div id="register_wrapper">
    <p style="margin-left:165px;">Entries marked * are required fields.</p>  
    <h2>Register</h2>
    <form action="<?php echo WS_URL . "register/"; ?>" method="POST" id="registerForm" enctype="multipart/form-data">
      ...
      <div id="registerFormCompanyLogo" style='height:130px;'>
          ...
          <iframe id='uploadIframe' class='right' style='clear: both; width:60%; min-width:100%; height:100px; min-height:100px;' src='<?php echo WS_URL?>html/blocks/usersFileUpload.php' class='upload_frame'></iframe>
    </div>
