...
if(sqlsrv_has_rows($result))
{
  ...
  $html .= "<img style='border-style: solid; border-width: 1px; max-width:150px; max-height:150px; position: absolute; top:10px;' src='/media/uploads/{$answers['file']}'> ";
  $html .= "<h1 style='position: absolute; top:10px; right: 300px;'>" . $answers['name'] . "</h1><br /><br />";
