...
$css .= "img {max-width: 400px; max-height:300px; width:80%;margin-left:20%;}\n";
$css .= ".imgCaption {display:block; text-align:left; font-weight:bold; width:400px; font-size: 80%; margin-left:20%}\n";
