<h2>Wastewater Treatment System</h2>
<h3 class="question_header">Wastewater Treatment System</h3>
<div class="question_set_wrapper hidden">
  <form id="f_1" class="main_form">
  <?php
    $sql = "SELECT * FROM questions WHERE category = 4";
...
<div class="question_set_wrapper hidden">
  <form id="f_1" class="main_form">
  <?php
    $sql = "SELECT * FROM questions WHERE category = 5";
    $result = $database->query($sql);
    if($result->num_rows >= 1)
    {
          $questions = $result;
